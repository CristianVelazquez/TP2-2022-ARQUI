...
# LEDs with carry
set_property PACKAGE_PIN U16 [get_ports {o_data_debug[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[0]}]
set_property PACKAGE_PIN E19 [get_ports {o_data_debug[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[1]}]
set_property PACKAGE_PIN U19 [get_ports {o_data_debug[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[2]}]
set_property PACKAGE_PIN V19 [get_ports {o_data_debug[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[3]}]
set_property PACKAGE_PIN W18 [get_ports {o_data_debug[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[4]}]
set_property PACKAGE_PIN U15 [get_ports {o_data_debug[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[5]}]
set_property PACKAGE_PIN U14 [get_ports {o_data_debug[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[6]}]
set_property PACKAGE_PIN V14 [get_ports {o_data_debug[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data_debug[7]}]
